...
export default async function DashboardPage({ searchParams }: DashboardPageProps) {
  ...
  return (
    <SharedDashboardView
      ...
      healthItems={[
        { label: "Pendientes",    value: pendingOrders,    hint: "sin procesar" },
        { label: "En producción", value: inProgressOrders, hint: "flujo activo" },
        { label: "Con envío",     value: withShipment,     hint: "etiquetados" },
        { label: "Entregados",    value: deliveredOrders,  hint: "cerrados" },
      ]}
