    ...
    <div className="exp-page">
      ...
      <div className="exp-kpi-strip">
        <article className="exp-kpi-card is-accent">
          <span className="exp-kpi-label">Expediciones creadas</span><div className="exp-kpi-icon">🏷️</div>
        ...
        <article className="exp-kpi-card is-green">
          <span className="exp-kpi-label">Entregadas</span><div className="exp-kpi-icon">✅</div>
        ...
        <article className="exp-kpi-card is-blue">
          <span className="exp-kpi-label">En tránsito</span><div className="exp-kpi-icon">🚚</div>
        ...
        <article className="exp-kpi-card is-red">
          <span className="exp-kpi-label">Incidencias</span><div className="exp-kpi-icon">🚨</div>
        ...
        <article className="exp-kpi-card is-orange">
          <span className="exp-kpi-label">On-time delivery</span><div className="exp-kpi-icon">⏱️</div>
        ...
        <article className="exp-kpi-card is-slate">
          <span className="exp-kpi-label">Transit time medio</span><div className="exp-kpi-icon">📍</div>
        ...
        <article className="exp-kpi-card is-slate">
          <span className="exp-kpi-label">Pedido → entrega</span><div className="exp-kpi-icon">📅</div>
